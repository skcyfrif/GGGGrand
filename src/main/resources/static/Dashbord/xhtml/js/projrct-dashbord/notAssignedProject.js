document.addEventListener("DOMContentLoaded", function () {
    ...
    // fetch("http://88.222.241.45:9080/api/project/projects/un-publish/count")
        .then(response => {
            if (!response.ok) {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchProjects() {
        ...
        // fetch('http://88.222.241.45:9080/api/project/un-publish-projects')
    ...
    function publishProject(projectId) {
        ...
        // fetch(`http://88.222.241.45:9080/api/project/${projectId}/assign-to-managers`, {
            method: 'POST',
        })
            .then(response => {
                if (response.ok) {
