document.addEventListener("DOMContentLoaded", function () {
    ...
    // fetch("http://88.222.241.45:9080/api/project/count-assigned-projects-last-year")
...
async function fetchProjects() {
    try {
        ...
        // const response = await fetch('http://88.222.241.45:9080/api/project/assigned-projects-registered-last-year');
