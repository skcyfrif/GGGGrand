...
//		project.setManager(manager);
	...
	public long countAssignedProjectsLastYear() {
		...
		return projectRepository.countByStatusAndRegistrationDateBetween("ASSIGNED", startOfLastYear,
				endOfLastYear);
	}
    ...
    public List<Project> getAssignedProjectsRegisteredLastYear() {
        ...
        // Fetch the projects that are "ASSIGNED_PROJECTS" and registered in the last year
